...
def main():
    report("A ler tarefa e SOUL.md do perfil Wiki...", 10)
    ...
    # Perfis wiki podem precisar de referenciar a LLM Wiki
    soul_path = Path.home() / ".hermes" / "profiles" / "wiki" / "SOUL.md"
    wiki_root = Path("/media/sf_AI_Ecosystem/12_LLM_Wiki")
    soul = ""
    if soul_path.exists():
...
## INSTRUCOES
1. Antes de responder, CONSULTA a LLM Wiki em {wiki_root}
2. Se a tarefa envolve modificacao de ficheiros markdown, usa SOEN file tools e patches precisos.
3. Depois de qualquer alteracao, ATUALIZA index.md e log.md da wiki.
